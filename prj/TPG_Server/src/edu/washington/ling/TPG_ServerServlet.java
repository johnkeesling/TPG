...
public class TPG_ServerServlet extends HttpServlet {
	 ...
	 *  test different queries.  Currently, QUERY is unused, except when adding terms to
	 *  QUERY_STRING.  
	 *  
	...
	private static final String QUERY_STRING = "shot win loss attempt effort goal score assist plai maneuv turnov penalti disadvantag powerplai block whistl stop playoff start";
	...
	protected String arrangeTweets(Tweet[] messages) throws Exception {
		String result = "";
	 ...
	 *  
	 *  @param req, resp
	 *  void but returns all necessary information to the client
	 *  
	 */
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		// Get and process the query info
		...
		// Load the schedule file and check for a game
		...
		Tweet[] tweets = loadTwitter(teamName, Date, Date);
		...
		// Add a print statement if the stemmed words are needed
		PorterStemmer stemmer = new PorterStemmer();
		String stemmedQuery = "";
